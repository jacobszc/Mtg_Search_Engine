...
public class AllPrintingsJsonDocumentConverter : IJsonDocument , IDisposable
{
   ...
   public AllPrintingsJsonDocumentConverter(string path){      // contrcutor automaticly converts json string to json doc
